...
function make_gauges() {
    ...
    const gauge = [
        new reflect_html_1.HtmlElement("circle", {
            cx: 0,
            cy: 0,
            fill: "transparent",
            r: stroke_radius,
        ...
        new reflect_html_1.HtmlElement("line", {
            id: "line1",
            class: "line",
    ...
    const elements = [
        new reflect_html_1.HtmlElement("g", {
    ...
    return new reflect_html_1.HtmlElement("svg", { width: 200, height: 200 }, elements);
}
exports.make_gauges = make_gauges;
